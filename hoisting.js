...
(function() {
    ...
    /* 
        Any global variable named `name` overwrites `window.name` property.
    ...
    */
    ...
    console.log("name + this.name", name + this.name); // "undefined1"
    var name = "2";
    console.log("name + this.name", name + this.name); // 21
})();